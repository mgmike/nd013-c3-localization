...
Eigen::Matrix4d ICPS(PointCloudT::Ptr target, PointCloudT::Ptr source, Pose startingPose, int iterations, int dist = 2){
	...
	pcl::KdTreeFLANN<PointT> kdtree;
  	...
  	Eigen::Matrix4d transformation_matrix_old = transform3D(startingPose.rotation.yaw, startingPose.rotation.pitch, startingPose.rotation.roll, 
                                                startingPose.position.x, startingPose.position.y, startingPose.position.z);
  	Eigen::Matrix4d transformation_matrix = transformation_matrix_old;
